...
PHP_SOLR_API void solr_create_document_field_object(solr_field_list_t *field_values, zval **field_obj TSRMLS_DC)
{
	...
	zend_update_property_string(solr_ce_SolrDocumentField, doc_field, SOLR_FIELD_MODIFIER_PROPERTY_NAME, sizeof(SOLR_FIELD_MODIFIER_PROPERTY_NAME)-1, field_values->field_modifier TSRMLS_CC);
